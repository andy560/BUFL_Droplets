...
while run == 'y' 
    ...
    while isempty(FullPath)
        [FileName,PathName] = uigetfile('/Users/andysabo/Library/CloudStorage/GoogleDrive-asabo@bu.edu/.shortcut-targets-by-id/1JFj7IHPTVApFOT8rmEDZNLNh2Y8jhnQE/20230304 Fourth blood bag/*.*', 'Select Video');
    ...
    while in ~= 'e'
        ...
        if in == 'c'
            in = 'e';
            trow = trow - 1;
            fprintf('File Choice Canceled\n')
        end
        
    end


    clearvars -except data trow hem rh
    ...
    excelname = strcat(hem, '_', rh, '.xlsx');
